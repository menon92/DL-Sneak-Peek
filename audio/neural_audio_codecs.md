...
এই অংশে অডিও ডাটা কে কিছু এক ডাইমেনশন (1D) কনভোলুশনাল লেয়ার মধ্যে দিয়ে pass করে অডিও ডাটা কে কিছুটা কমপ্রেস করা হয়। এই কমপ্রেস অডিও কে বলা হয় ল্যাটেন্ট স্পেস বা ল্যাটেন্ট ভেক্টর। [Check encoder block of Figure 2 in SEANet](https://arxiv.org/pdf/2009.02095)
...
এই ক্ষেত্রে আমরা ব্যবহার করতে পারি [Euclidean distance](https://en.wikipedia.org/wiki/Euclidean_distance) এই ইউক্লিডিয়ান ডিস্ট্যান্স ভ্যালু থেকে আমার বের করতে পারো দুইটা ভেক্টর কতটা কাছাকাছি।  দুটি ভেক্টরের ইউক্লিডিয়ান ডিস্ট্যান্স যত বেশি হবে তারা ততো দূরে। আর ইউক্লিডিয়ান ডিস্ট্যান্স যত কম হবে তারা ততো কাছে
